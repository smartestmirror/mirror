...
//import * as faceRec from '/modules/MMM-Facial-Recognition/node_helper.js'
// const os = require("os");
    ...
    processAction: function(payload) {
        ...
        switch (payload) {
            ...
            case "openDevTools":
                ...
                break;
            case "profile":
                exec("modules/MMM-OnScreenMenu/create_user", opts, (error,stdout, stderr) => { self.checkForExecError(error, stdout, stderr); });
                break;
            default:
