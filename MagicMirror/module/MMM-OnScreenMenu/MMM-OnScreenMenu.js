...
Module.register("MMM-OnScreenMenu", {
    defaults: {
        ...
        menuItems: {
            ...
            profile: { title: "Create Profile", icon: "television", source: "ALL"},
        },
        enableKeyboard: true,
    ...
    doMenuAction: function(action) {
        ...
        var nodeActions = ["monitorOn", "monitorOff", "monitorToggle", "restart", "reboot", "shutdown", "stop", "minimize", "toggleFullscreen", "openDevTools", "profile"];
